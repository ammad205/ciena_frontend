...
/* custom function for setting the maximum values of knobs */
function getKnobMaxValue(elemName) {
	if (elemName == "knob-srv-1") return 100
	else if (elemName == "knob-srv-2") return 100
	else if (elemName == "knob-srv-3") return 1024
	else if (elemName == "knob-srv-4") return 1024
}
...
function RedrawKnob(elem){
	elem.animate({
		...
		progress: function()
		{
			//console.log(elem[0].id + ' = bilal')
			$(this).val(parseInt(Math.ceil(elem.val()))).trigger('change');
			$(this).val(Math.round(elem.val()) + '%');
		}
	});
}


function RedrawKnobWithValue(elem,value,symbol){
	elem.animate({
		value: value
	},{
		duration: 1000,
		...
		{
			$(this).val(parseInt(Math.ceil(elem.val()))).trigger('change');
			$(this).val(Math.round(elem.val()) + symbol);
		}
	});
}
//
